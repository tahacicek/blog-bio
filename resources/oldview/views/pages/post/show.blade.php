<x-app-layout>
    ...
    <header class="page-header">
        ...
        <p class="author">
            ...
            <br>
            <span class="text-sm"> {{ \Carbon\Carbon::parse($post->created_at)->format('d M, Y') }}</span> tarihinde,
            okuma süresi, {{ $post->reading_time }} dakika.
        </p>
        @foreach ($tags as $tag)
            <a href=""> <span class="badge bg-primary mt-2">{{ '#' . $tag->name }}</span></a>
        @endforeach
    </header>
                ...
                <article class="col-6">
                    <div class="post-wrap">
                        ...
                        <div class="post-detail">
                            ...
                            <p><em></em>{{ Str::limit($post->excerpt, 40) }}</p>
                                    ...
                                    @else
                                        @if ($loop->last)
                                            ve diğer <button data-id="{{ $post->id }}" data-bs-toggle="modal"
                                                ...
                                                class="p-1 btn btn-outline-dark btn-lg">{{ $total_user }} kişi
                                            </button>
                                            bu yazıda bir işlemler yaptı.
                                        @else
                                            <a href="/{{ $user->username }}">{{ $user->username }}</a>,
                        ...
                        <div class="block block-rounded block-themed block-transparent mb-0">
                            <div class="block-header bg-dark">
                                ...
                                <div class="block-options">
                                    <button type="button" class="btn-block-option text-danger"
