            ...
            <ul id="ui-elements" class="iq-submenu collapse" data-bs-parent="#iq-sidebar-toggle">
                <li class="">
                    <a href="#ui-kit" data-bs-toggle="collapse" class="  collapsed"
                        aria-expanded="false"><i class="ri-pencil-ruler-line"></i><span>UI
                    ...
                    <ul id="ui-kit" class="iq-submenu collapse" data-bs-parent="#ui-elements">
                        <li class="">
                            <a href="../dashboard/ui-color.html"><i
                                    class="ri-font-color"></i>Colors</a>
                        </li>
                        <li class=" ">
                        ...
                        <li class="">
                            <a href="../dashboard/ui-grid.html"><i
                                    class="ri-grid-line"></i>Grid</a>
                        </li>
                        <li class="">
                        ...
                        <li class="">
                            <a href="ui-pagination.html"><i
                                    class="ri-pages-line"></i>Pagination</a>
                        </li>
                        <li class="">
                ...
                <li class="">
                    ...
                    <ul id="forms" class="iq-submenu collapse" data-bs-parent="#ui-elements">
                        <li class="">
                            <a href="../dashboard/form-layout.html"><i
                                    class="ri-tablet-line"></i>Form Elements</a>
                        </li>
                        <li class="">
                        ...
                        <li class="">
                            <a href="../dashboard/form-switch.html"><i
                                    class="ri-toggle-line"></i>Form Switch</a>
                        </li>
                        <li class="">
                ...
                <li class="">
                    ...
                    <ul id="wizard-form" class="iq-submenu collapse"
