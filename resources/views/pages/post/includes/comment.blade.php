...
<div class="d-flex">
    ...
    <div class="flex-grow-1">
        <div class="">
            <a class="fw-semibold" id="user"
                href="javascript:void(0)">{{ '@' . $comment->user->username }} </a>diyo ki
            @if ($comment->user->id == Auth::user()->id)
                ...
                <button class="float-end border-0 me-1  bg-white"><i
                        class="fa fa-pencil text-warning" aria-hidden="true"></i></button>
                <button class="float-end border-0 me-1 bg-white"><i
        ...
        <div class="mb-2 mt-2 reply_form" id="reply_form{{ $comment->id }}"
            style="display:none">
        ...
        <hr class="hrs2">
            ...
            <div class="d-flex m-0" id="parent_detail">
                <a class="flex-shrink-0 img-link me-2" href="javascript:void(0)">
                ...
                <div class="flex-grow-1">
                    <p class="mb-1">
                        <a class="fw-semibold"
                            href="javascript:void(0)">{{ '@' . $child->user->username }}</a>
                    <p>
                        {{ $child->comment }}
                    </p>
                    </p>
